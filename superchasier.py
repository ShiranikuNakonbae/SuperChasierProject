...
class Transactions:
    ...
    current_cart_msg : the message will be displayed the current condition of the cart.
    ...
    def display_cart(self):
        ...
        It can be called among function within this class.
    ...
    def update_item_count(self, item_name, new_count): 
        ...
        Input:
        item_name [String] - The name of the item user has entered into the cart.
        new_count [Integer] - The item_names's new_count user want to update.
